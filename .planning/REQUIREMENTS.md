...
- [ ] **OUT-01**: Caller can mix a melody layer and an ambient layer at configurable relative volumes
- [ ] **OUT-02**: Mixed output is normalized to prevent int16 clipping/overflow before WAV write
- [ ] **OUT-03**: Caller can render the mixed output to a WAV file at a specified duration
- [ ] **OUT-04**: Generated WAV loops seamlessly — crossfade + zero-crossing boundary enforcement, no audible click at loop point
- [ ] **OUT-05**: Caller can specify fade-in and fade-out duration at file boundaries
